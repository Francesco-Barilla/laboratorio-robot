...
HELP = (
    ...
    ('Scrivere e correggere', 'Clicca nel codice per scrivere. Tab inserisce quattro spazi. Ctrl+A seleziona tutto; Ctrl+C, Ctrl+X e Ctrl+V copiano, tagliano e incollano; Ctrl+Z annulla e Ctrl+Y ripristina. Frecce e rotella scorrono; Shift + rotella scorre orizzontalmente le righe lunghe. Modificare il programma azzera soltanto la simulazione, conservando il testo.'),
